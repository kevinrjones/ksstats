...
object JooqBattingGroundsRecords {
    ...
    fun createResultsCte(
        ...
        teamsCteName: String,
        searchParameters: SearchParameters,
    ): SelectJoinStep<Record21<Int?, String?, String?, String, String, Int, Int, Int, Int, Double, Int, Int, Int, Int, Int, Int, String?, String?, Serializable, Serializable, Serializable>> {
