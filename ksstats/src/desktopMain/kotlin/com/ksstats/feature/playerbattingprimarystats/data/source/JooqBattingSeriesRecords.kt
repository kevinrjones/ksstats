...
object JooqBattingSeriesRecords {

    fun createTemporaryBattingCte(
        searchParameters: SearchParameters,
    ): SelectJoinStep<Record19<Int, String, Int, Int, Int, Int, Int, Int, Int, Int, Double, Int, Int, Int, Int, Int, Int, Int, String>> {
        ...
        val cte =
            select(
                ...
                select(
                    ...
                    .groupBy(field("playerid"),field("teamid"), field("opponentsid"),field("seriesnumber"),field("seriesdate"),)
                    .asTable("innings")
