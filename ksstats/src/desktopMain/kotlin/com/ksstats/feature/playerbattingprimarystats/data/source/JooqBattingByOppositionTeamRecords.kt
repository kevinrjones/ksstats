...
object JooqBattingByOppositionTeamRecords {
    ...
    fun createResultsCte(
        ...
        teamsCteName: String,
        searchParameters: SearchParameters,
    ): SelectJoinStep<Record19<Int?, String?, String?, String, String, Int, Int, Int, Int, Double, Int, Int, Int, Int, Int, Int, Serializable, Serializable, Serializable>> {
        ...
        val cte =
            select(
                ...
                select(
                    ...
                    .leftJoin(TEAMS.`as`("O")).on(field("O.id").eq(field("OpponentsId")))
