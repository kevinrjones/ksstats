...
object JooqBowlingByYearOfMatchStartRecords {
    ...
    fun createTemporaryBowlingCte(
        ...
        val cte =
            select(
                ...
                field("m.MatchStartYear", Double::class.java),
            ).from(
                select()
                    .from(BOWLINGDETAILS)
                    .where(
    ...
    fun createResultsCte(
        ...
        val cte =
            select(
                ...
                field("innings.matchStartYear", Double::class.java).`as`("year"),
                ...
                select(
                    ...
                    .leftJoin(TEAMS.`as`("O")).on(field("O.id").eq(field("innings.MatchStartYear")))
                    ...
                    .and(
                        field("${fivesCteName}.MatchStartYear", Int::class.java)
                            .eq(field("innings.MatchStartYear", Int::class.java))
                    )
                    ...
                    .and(
                        field("${tensCteName}.MatchStartYear", Int::class.java)
                            .eq(field("innings.MatchStartYear", Int::class.java))
                    )
                    ...
                    .and(
                        field("${bbmCteName}.MatchStartYear", Int::class.java)
                            .eq(field("innings.MatchStartYear", Int::class.java))
                    )
    ...
    fun createBbmAll(
        ...
        val cte = select(
            ...
            .groupBy(field("playerId"), field("matchId"), field("MatchStartYear"))
