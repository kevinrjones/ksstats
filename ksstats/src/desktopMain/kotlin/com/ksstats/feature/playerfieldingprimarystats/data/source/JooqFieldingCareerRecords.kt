...
object JooqFieldingCareerRecords {
    ...
    fun createTemporaryFieldingCounts(fieldingCteName: String): SelectHavingStep<Record6<Int, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal>> {
        return select(
            ...
            .groupBy(field("playerid"), field("matchtype"))
    }

    fun createTemporaryFieldingBest(fieldingCteName: String): SelectConditionStep<Record6<Int, String, Int, Int, Int, Int>> {
        return select(
            field("playerId", Int::class.java),
            field("matchType", String::class.java),
    ...
    fun createTemporaryPlayed(fieldingCteName: String): SelectHavingStep<Record2<Int, Int>> {
        return select(
            field("playerId", Int::class.java),
            count().`as`("matches"),
        ).from(fieldingCteName)
