...
object JooqFieldingByYearOfMatchStartRecords {
    ...
    fun createTemporaryFieldingCounts(fieldingCteName: String): SelectHavingStep<Record7<Int, Int, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal>> {
        return select(
            ...
            .groupBy(field("playerid"), field("matchStartYear"), field("matchtype"))
    }
    ...
    fun createTemporaryFieldingBest(fieldingCteName: String): SelectConditionStep<Record7<Int, Int, String, Int, Int, Int, Int>> {
        return select(
            ...
            select(
                ...
                field("stumped", Int::class.java),
                field("dismissals", Int::class.java),
                rowNumber().over().partitionBy(field("playerid"), field("matchStartYear"), field("matchStartYear"))
    ...
    fun createTemporaryPlayed(fieldingCteName: String): SelectHavingStep<Record3<Int, Int, Int>> {
        return select(
            ...
            .groupBy(field("playerid"),field("matchStartYear"))
    }
    ...
    fun createResultsCte(
        ...
        val cte =
            select(
                ...
                field("${fieldingCountsName}.matchStartYear", Int::class.java).`as`("year"),
                ...
                .and(field("${fieldingPlayedName}.matchStartYear").eq(field("${fieldingCountsName}.matchStartYear")))
                .leftJoin(fieldingInningsName)
                .on(field("${fieldingInningsName}.playerId").eq(field("${fieldingCountsName}.playerId")))
                .and(field("${fieldingInningsName}.matchStartYear").eq(field("${fieldingCountsName}.matchStartYear")))
                ...
                .and(field("${fieldingBestName}.matchStartYear").eq(field("${fieldingCountsName}.matchStartYear")))
