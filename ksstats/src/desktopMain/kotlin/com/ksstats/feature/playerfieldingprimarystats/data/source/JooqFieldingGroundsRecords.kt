...
object JooqFieldingGroundsRecords {
    ...
    fun createTemporaryFieldingCounts(fieldingCteName: String): SelectHavingStep<Record7<Int, Int, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal>> {
        return select(
            ...
            .groupBy(field("playerid"), field("LocationId"), field("matchtype"))
    }
    ...
    fun createTemporaryFieldingBest(fieldingCteName: String): SelectConditionStep<Record7<Int, Int, String, Int, Int, Int, Int>> {
        return select(
            ...
            select(
                ...
                field("stumped", Int::class.java),
                field("dismissals", Int::class.java),
                rowNumber().over().partitionBy(field("playerid"), field("LocationId"), field("LocationId"))
    ...
    fun createResultsCte(
        ...
        val cte =
            select(
                ...
                concat(GROUNDS.COUNTRYNAME, `val`(" - "), GROUNDS.KNOWNAS).`as`("Ground"),
                ...
                .and(field("${fieldingPlayedName}.LocationId").eq(field("${fieldingCountsName}.LocationId")))
                .leftJoin(fieldingInningsName)
                .on(field("${fieldingInningsName}.playerId").eq(field("${fieldingCountsName}.playerId")))
                .and(field("${fieldingInningsName}.LocationId").eq(field("${fieldingCountsName}.LocationId")))
                ...
                .and(field("${fieldingBestName}.LocationId").eq(field("${fieldingCountsName}.LocationId")))
                ...
                .join(GROUNDS).on(GROUNDS.ID.eq(field("${fieldingCountsName}.LocationId", Int::class.java)))
