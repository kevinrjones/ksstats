...
object JooqFieldingByHostRecords {


    fun createTemporaryFieldingCte(
        searchParameters: SearchParameters,
    ): SelectJoinStep<Record11<Int, Int, String, Int, Int, Int, Int, Int, Double, Int, Int>> {
    ...
    fun createTemporaryFieldingCounts(fieldingCteName: String): SelectHavingStep<Record7<Int, Int, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal>> {
        return select(
            ...
            .groupBy(field("playerid"), field("HomeCountryId"), field("matchtype"))
    }
    ...
    fun createTemporaryFieldingBest(fieldingCteName: String): SelectConditionStep<Record7<Int, Int, String, Int, Int, Int, Int>> {
        return select(
            ...
            select(
                ...
                field("stumped", Int::class.java),
                field("dismissals", Int::class.java),
                rowNumber().over().partitionBy(field("playerid"), field("HomeCountryId"), field("HomeCountryId"))
    ...
    fun createTemporaryPlayed(fieldingCteName: String): SelectHavingStep<Record3<Int, Int, Int>> {
        return select(
            ...
            .groupBy(field("playerid"), field("HomeCountryId"))
    }
    ...
    fun createResultsCte(
    ...
    ): SelectConditionStep<Record18<Int?, String?, String?, String, String, String?, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int>> {
        ...
        val cte =
            select(
                ...
                .and(field("${fieldingPlayedName}.HomeCountryId").eq(field("${fieldingCountsName}.HomeCountryId")))
                .leftJoin(fieldingInningsName)
                .on(field("${fieldingInningsName}.playerId").eq(field("${fieldingCountsName}.playerId")))
                .and(field("${fieldingInningsName}.HomeCountryId").eq(field("${fieldingCountsName}.HomeCountryId")))
                ...
                .and(field("${fieldingBestName}.HomeCountryId").eq(field("${fieldingCountsName}.HomeCountryId")))
                ...
                .join(COUNTRIES).on(COUNTRIES.ID.eq(field("${fieldingCountsName}.HomeCountryId", Int::class.java)))
