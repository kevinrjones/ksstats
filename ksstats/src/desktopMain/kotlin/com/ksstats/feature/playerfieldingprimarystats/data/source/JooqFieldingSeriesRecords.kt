...
object JooqFieldingSeriesRecords {

    fun createTemporaryFieldingCte(
        searchParameters: SearchParameters,
    ): SelectJoinStep<Record12<Int, Int, String, Int, Int, Int, Int, Int, Double, Int, Int, Int>> {
        ...
        val cte =
            select(
                ...
                field("matches.seriesNumber", Int::class.java),
                field("matches.seriesDate", Int::class.java),
            ).from(
                select()
                    .from(FIELDING)
                    .where(
    ...
    fun createTemporaryFieldingCounts(fieldingCteName: String): SelectHavingStep<Record8<Int, Int, Int, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal>> {
        return select(
            ...
            .groupBy(field("playerid"), field("seriesNumber"), field("matchtype"))
    }
    ...
    fun createTemporaryFieldingBest(fieldingCteName: String): SelectConditionStep<Record7<Int, Int, String, Int, Int, Int, Int>> {
        return select(
            ...
            select(
                ...
                field("stumped", Int::class.java),
                field("dismissals", Int::class.java),
                rowNumber().over().partitionBy(field("playerid"), field("seriesNumber"), field("seriesDate"))
    ...
    fun createTemporaryPlayed(fieldingCteName: String): SelectHavingStep<Record4<Int, Int, Int, Int>> {
        return select(
            field("playerId", Int::class.java),
            field("seriesNumber", Int::class.java),
            ...
            .groupBy(field("playerid"),field("opponentsId"), field("seriesNumber"))
    }
    ...
    fun createResultsCte(
    ...
    ): SelectConditionStep<Record18<Int?, String?, String?, String, String, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int>> {
        ...
        val cte =
            select(
                ...
                field("${fieldingCountsName}.seriesDate", Int::class.java).`as`("year"),
                ...
                .and(field("${fieldingPlayedName}.seriesNumber").eq(field("${fieldingCountsName}.seriesNumber")))
                .leftJoin(fieldingInningsName)
                .on(field("${fieldingInningsName}.playerId").eq(field("${fieldingCountsName}.playerId")))
                .and(field("${fieldingInningsName}.seriesNumber").eq(field("${fieldingCountsName}.seriesNumber")))
                ...
                .and(field("${fieldingBestName}.seriesNumber").eq(field("${fieldingCountsName}.seriesNumber")))
                ...
                .leftJoin(TEAMS.`as`("O")).on(field("O.id").eq(field("${fieldingPlayedName}.opponentsId")))
