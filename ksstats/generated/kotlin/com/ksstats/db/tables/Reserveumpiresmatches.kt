...
import com.ksstats.db.tables.Reserveumpires.ReserveumpiresPath
...
open class Reserveumpiresmatches(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>ReserveUmpiresMatches</code>
         */
    ...
    /**
     * The column <code>ReserveUmpiresMatches.PersonId</code>.
     */
    ...
    /**
     * The column <code>ReserveUmpiresMatches.MatchId</code>.
     */
    ...
    /**
     * Create an aliased <code>ReserveUmpiresMatches</code> table reference
     */
    ...
    /**
     * Create a <code>ReserveUmpiresMatches</code> table reference
     */
    ...
    override fun getReferences(): List<ForeignKey<ReserveumpiresmatchesRecord, *>> = listOf(RESERVEUMPIRESMATCHES__FK_RESERVEUMPIRESMATCHES_PK_RESERVEUMPIRES, RESERVEUMPIRESMATCHES__FK_RESERVEUMPIRESMATCHES_PK_MATCHES)

    private lateinit var _reserveumpires: ReserveumpiresPath

    /**
     * Get the implicit join path to the <code>ReserveUmpires</code> table.
     */
    fun reserveumpires(): ReserveumpiresPath {
        if (!this::_reserveumpires.isInitialized)
            _reserveumpires = ReserveumpiresPath(this, RESERVEUMPIRESMATCHES__FK_RESERVEUMPIRESMATCHES_PK_RESERVEUMPIRES, null)
    ...
    fun matches(): MatchesPath {
        if (!this::_matches.isInitialized)
            _matches = MatchesPath(this, RESERVEUMPIRESMATCHES__FK_RESERVEUMPIRESMATCHES_PK_MATCHES, null)
