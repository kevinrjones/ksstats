...
import com.ksstats.db.indexes.SCORERS_DEBUTMATCHID
import com.ksstats.db.indexes.SCORERS_UMPIRESID
import com.ksstats.db.keys.SCORERSMATCHES__FK_SCORERSMATCHES_PK_SCORERS
import com.ksstats.db.keys.SCORERS__PK_SCORERS
...
open class Scorers(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>Scorers</code>
         */
    ...
    /**
     * The column <code>Scorers.Id</code>.
     */
    val ID: TableField<ScorersRecord, Int?> = createField(DSL.name("Id"), SQLDataType.INTEGER.identity(true), this, "")

    /**
     * The column <code>Scorers.ScorersId</code>.
     */
    val SCORERSID: TableField<ScorersRecord, Int?> = createField(DSL.name("ScorersId"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>Scorers.FullName</code>.
     */
    val FULLNAME: TableField<ScorersRecord, String?> = createField(DSL.name("FullName"), SQLDataType.VARCHAR(200).nullable(false), this, "")

    /**
     * The column <code>Scorers.SortNamePart</code>.
     */
    ...
    /**
     * The column <code>Scorers.OtherNamePart</code>.
     */
    ...
    /**
     * The column <code>Scorers.DebutMatchId</code>.
     */
    ...
    /**
     * Create an aliased <code>Scorers</code> table reference
     */
    ...
    /**
     * Create a <code>Scorers</code> table reference
     */
    ...
    override fun getIndexes(): List<Index> = listOf(SCORERS_DEBUTMATCHID, SCORERS_UMPIRESID)
    override fun getIdentity(): Identity<ScorersRecord, Int?> = super.getIdentity() as Identity<ScorersRecord, Int?>
    override fun getPrimaryKey(): UniqueKey<ScorersRecord> = SCORERS__PK_SCORERS
    ...
    fun scorersmatches(): ScorersmatchesPath {
        if (!this::_scorersmatches.isInitialized)
            _scorersmatches = ScorersmatchesPath(this, null, SCORERSMATCHES__FK_SCORERSMATCHES_PK_SCORERS.inverseKey)
