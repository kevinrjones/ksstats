...
import com.ksstats.db.indexes.RESERVEUMPIRES_DEBUTMATCHID
import com.ksstats.db.indexes.UMPIRES_DEBUTMATCHID
import com.ksstats.db.indexes.UMPIRES_UMPIRESID
import com.ksstats.db.keys.UMPIRESMATCHES__FK_UMPIRESMATCHES_PK_UMPIRES
import com.ksstats.db.keys.UMPIRES__PK_UMPIRES
...
open class Umpires(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>Umpires</code>
         */
    ...
    /**
     * The column <code>Umpires.Id</code>.
     */
    val ID: TableField<UmpiresRecord, Int?> = createField(DSL.name("Id"), SQLDataType.INTEGER.identity(true), this, "")

    /**
     * The column <code>Umpires.UmpiresId</code>.
     */
    val UMPIRESID: TableField<UmpiresRecord, Int?> = createField(DSL.name("UmpiresId"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>Umpires.FullName</code>.
     */
    val FULLNAME: TableField<UmpiresRecord, String?> = createField(DSL.name("FullName"), SQLDataType.VARCHAR(200).nullable(false), this, "")

    /**
     * The column <code>Umpires.SortNamePart</code>.
     */
    ...
    /**
     * The column <code>Umpires.OtherNamePart</code>.
     */
    ...
    /**
     * The column <code>Umpires.DebutMatchId</code>.
     */
    ...
    /**
     * Create an aliased <code>Umpires</code> table reference
     */
    ...
    /**
     * Create a <code>Umpires</code> table reference
     */
    ...
    override fun getIndexes(): List<Index> = listOf(RESERVEUMPIRES_DEBUTMATCHID, UMPIRES_DEBUTMATCHID, UMPIRES_UMPIRESID)
    override fun getIdentity(): Identity<UmpiresRecord, Int?> = super.getIdentity() as Identity<UmpiresRecord, Int?>
    override fun getPrimaryKey(): UniqueKey<UmpiresRecord> = UMPIRES__PK_UMPIRES
    ...
    fun umpiresmatches(): UmpiresmatchesPath {
        if (!this::_umpiresmatches.isInitialized)
            _umpiresmatches = UmpiresmatchesPath(this, null, UMPIRESMATCHES__FK_UMPIRESMATCHES_PK_UMPIRES.inverseKey)
