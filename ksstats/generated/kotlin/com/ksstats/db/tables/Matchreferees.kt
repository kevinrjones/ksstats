...
import com.ksstats.db.indexes.MATCHREFEREES_DEBUTMATCHID
import com.ksstats.db.indexes.MATCHREFEREES_UMPIRESID
import com.ksstats.db.keys.MATCHREFEREESMATCHES__FK_MATCHREFEREESMATCHES_PK_MATCHREFEREES
import com.ksstats.db.keys.MATCHREFEREES__PK_MATCHREFEREES
...
open class Matchreferees(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>MatchReferees</code>
         */
    ...
    /**
     * The column <code>MatchReferees.Id</code>.
     */
    val ID: TableField<MatchrefereesRecord, Int?> = createField(DSL.name("Id"), SQLDataType.INTEGER.identity(true), this, "")

    /**
     * The column <code>MatchReferees.RefereesId</code>.
     */
    ...
    /**
     * The column <code>MatchReferees.FullName</code>.
     */
    ...
    /**
     * The column <code>MatchReferees.SortNamePart</code>.
     */
    ...
    /**
     * The column <code>MatchReferees.OtherNamePart</code>.
     */
    ...
    /**
     * The column <code>MatchReferees.DebutMatchId</code>.
     */
    ...
    /**
     * Create an aliased <code>MatchReferees</code> table reference
     */
    ...
    /**
     * Create a <code>MatchReferees</code> table reference
     */
    ...
    override fun getIndexes(): List<Index> = listOf(MATCHREFEREES_DEBUTMATCHID, MATCHREFEREES_UMPIRESID)
    override fun getIdentity(): Identity<MatchrefereesRecord, Int?> = super.getIdentity() as Identity<MatchrefereesRecord, Int?>
    override fun getPrimaryKey(): UniqueKey<MatchrefereesRecord> = MATCHREFEREES__PK_MATCHREFEREES
    ...
    fun matchrefereesmatches(): MatchrefereesmatchesPath {
        if (!this::_matchrefereesmatches.isInitialized)
            _matchrefereesmatches = MatchrefereesmatchesPath(this, null, MATCHREFEREESMATCHES__FK_MATCHREFEREESMATCHES_PK_MATCHREFEREES.inverseKey)
